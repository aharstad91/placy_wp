...
function placy_register_acf_fields() {
    ...
    acf_add_local_field_group(array(
        ...
        'fields' => array(
            ...
            array(
                'key' => 'field_poi_icon',
                'label' => 'Ikon (emoji eller Font Awesome)',
                'name' => 'poi_icon',
                'type' => 'text',
                'instructions' => 'Emoji (⚽, 🏊, 🌲) eller Font Awesome klassenavn (map-pin, anchor, tree)',
                'placeholder' => '⚽ eller map-pin',
                'maxlength' => 50,
                'show_in_graphql' => 1,
            ),
            array(
    ...
    acf_add_local_field_group(array(
        ...
        'fields' => array(
            array(
                ...
                'label' => 'Category Icon (SVG File)',
                'name' => 'category_icon',
                'graphql_field_name' => 'categoryIcon',
                'type' => 'file',
                'instructions' => 'Last opp en SVG-fil for denne kategorien. Last ned SVG fra fontawesome.com og last opp her.',
                'required' => 0,
                'return_format' => 'url',
                'library' => 'all',
                'mime_types' => 'svg',
